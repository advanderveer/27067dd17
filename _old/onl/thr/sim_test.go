...
func TestMessageBound(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{f: apd.New(999, -3), p: 1, n: 20, T: 2000, exp: 4.8}, // every stake holder is active
		{f: apd.New(999, -3), p: 2, n: 20, T: 2000, exp: 2.8}, // only half of the stake is active
		{f: apd.New(999, -3), p: 3, n: 20, T: 2000, exp: 3.2}, // only a third
		{f: apd.New(999, -3), p: 4, n: 20, T: 2000, exp: 2.5}, // only a fourth
